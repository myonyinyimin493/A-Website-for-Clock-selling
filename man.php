...
if (isset($_POST["add-to-cart"])) {
    if (isset($_SESSION["shopping_cart"])) {
        foreach ($_SESSION["shopping_cart"] as $cal) {
                ...
                <ul class="nav nav-tabs" role="tablist">      
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a class="list" href="man.php">Man's Watches</a></li>
                            <li><a class="list" href="women.php">Women's Watches</a></li>            
                        </ul>
                    </li>
        ...
        <div class="rol" style="margin-top: -20px;">
            <div id="man" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                    <li data-target="#man" data-slide-to="0"></li>
                    <li data-target="#man" data-slide-to="1"></li>
                    <li data-target="#man" data-slide-to="2"></li>
                </ol>

                <div class="carousel-inner">
                    <div class="item active">
                        <img src="man1.jpg" style="width:100%; height: 400px;">
                    </div>

                    <div class="item">
                        <img src="man2.jpg" style="width:100%; height: 400px;">
                    </div>

                    <div class="item">
                        <img src="rolex.jpg" style="width:100%; height: 400px;">
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <h1 class="heading">Man's Collection</h1><br />
            <?php

                require_once 'manwatch.php';
                manshow();
